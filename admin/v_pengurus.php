...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item px-2">
            <a href="v_pengurus.php" class="nav-link  active">Pengurus</a>
          </li>
          <li class="nav-item px-2">
  ...
  <header id="main-header" class="py-2 bg-success text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1><i class="fa fa-users"></i> Pengurus</h1>
        </div>
      </div>
    </div>
  </header>
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <img class="img-fluid" src="../img/<?php echo $data['foto']; ?>">
                    </td>
                    <td>
                      <a href="ubah_pengurus.php?id=<?php echo $data['id'];?>" class="btn btn-success">Ubah</a>
                    </td>
                    <td>
                      <a href="hapus_pengurus.php?id=<?php echo $data['id'];?>" class="btn btn-danger">Hapus</a>
                    </td>
                  </tr>
                <?php
                    $no++;
