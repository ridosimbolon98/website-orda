      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item ml-auto">
            <a href="v_post.php" class="nav-link">Kembali</a>
          </li>
  ...
  <div class="container mt-5">
    <div class="row">
        <div class="col-sm-12">
          ...
          <form method="post" action="ubah_post_aksi.php" enctype="multipart/form-data">
            <div class="form-group">
              <label for="title">Judul</label>
              <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
              <input type="text" name="judul" autofocus class="form-control" required value="<?php echo $data['judul']; ?>">
            </div>
            <div class="form-group">
              <label for="title">Isi</label>
              <input type="textarea" name="isi" class="form-control" required value="<?php echo $data['isi']; ?>">
            </div>
            <div class="form-group">
