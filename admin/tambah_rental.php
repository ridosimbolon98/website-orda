<?php 
  ...
  if(!empty($_FILES["foto"])){
    ...
    if (!$success) { 
      ...
      $insert = $koneksi->query("INSERT INTO `rental`(`nama`, `deskripsi`, `biaya`, `gambar`) VALUES ('$nama', '$deskripsi', '$biaya', '$name')");
      if($insert){
        echo "<script>alert('Data barang berhasil di upload ke database');</script>";
