      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item ml-auto">
            <a href="v_rental.php" class="nav-link">Kembali</a>
          </li>
  ...
  <div class="container mt-5">
    <div class="row">
        <div class="col-sm-12">
          ...
          <form method="post" action="ubah_rental_aksi.php" enctype="multipart/form-data">
            <div class="form-group">
              <label for="title">Nama Barang</label>
              <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
              <input type="text" name="nama" autofocus class="form-control" required value="<?php echo $data['nama']; ?>">
            </div>
            <div class="form-group">
              <label for="title">Deskripsi</label>
              <input type="textarea" name="deskripsi" class="form-control" required value="<?php echo $data['deskripsi']; ?>">
            </div>
            <div class="form-group">
              <label for="title">Biaya/ Hari</label>
              <input type="number" name="biaya" class="form-control" required value="<?php echo $data['biaya']; ?>">
            </div>
            <div class="form-group">
              <label for="title">Ubah Gambar Barang</label><br>
              <img class="img-fluid" src="../img/<?php echo $data['gambar'];?>" wiidth="20%">
