...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item px-2">
            <a href="v_post.php" class="nav-link active">Post</a>
          </li>
          <li class="nav-item px-2">
  ...
  <header id="main-header" class="py-2 bg-dark text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1><i class="fa fa-users"></i> Post Slideshow</h1>
        </div>
      </div>
    </div>
  </header>
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><img class="img-fluid" src="../img/<?php echo $data['gambar']; ?>" width="20%" height="20%"></td>
                    <td>
                      <a href="ubah_post.php?id=<?php echo $data['id'];?>" class="btn btn-dark">Ubah</a>
                    </td>
                  </tr>
                <?php
                    $no++;
